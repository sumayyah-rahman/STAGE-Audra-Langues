<?php
// mdp_oublie.php — réinitialisation du mot de passe
	...
	<body>
		<div class="login-container">
			...
			<form method="post" action="">
				<p>La réinitialisation automatique du mot de passe n’est pas encore disponible.</p>
				<p>Merci de contacter l’administrateur pour obtenir un nouveau mot de passe.</p>

    ...
    <body>
		...
		<div class="nav-bar">
			<ul>
				...
				<li><a href="cours_eleve.php" class="active">Cours</a></li>
        ...
        <div class="page">
            ...
            <section class="content-card">
                ...
                <div class="toc-box">
					...
					<p><strong>Niveau Actuel : </strong> <?= htmlspecialchars($niveauActuel) ?> <strong>→ Niveau Visé : </strong> <?= htmlspecialchars($niveauVise) ?></p>
